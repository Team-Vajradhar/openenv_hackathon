...
AI Incident Response Environment built using OpenEnv.

Simulates real-world DevOps incident response where an agent must diagnose
alerts, investigate logs/metrics, identify root cause, and mitigate the issue.

Tasks:
- Easy: Service crash
- Medium: Memory leak
- Hard: Database connection exhaustion
